...
今日消耗的 Token	Tokens used today
查看今天 Codex 和 Claude 的 Token 用量	View today's Codex and Claude token usage
暂无数据	No data yet
...
查看公网 IP、归属地、ASN 和标记	View public IP, location, ASN, and tags
